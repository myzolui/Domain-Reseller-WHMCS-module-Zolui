...
use ModulesGarden\DomainsReseller\Registrar\ZoluiDomainReseller\Calls;
use ModulesGarden\DomainsReseller\Registrar\ZoluiDomainReseller\Core\Configuration;
use ModulesGarden\DomainsReseller\Registrar\ZoluiDomainReseller\Helpers\ResultsListFactory;

//Loader
include_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Core' . DIRECTORY_SEPARATOR . "Loader.php";
new \ModulesGarden\DomainsReseller\Registrar\ZoluiDomainReseller\Core\Loader(__DIR__);
 ...
 * @return array $return
 */
function ZoluiDomainReseller_getConfigArray()
{
    $configarray = [
        "FriendlyName" => [
            "Type"  => "System",
            "Value" => "Zolui Domain Reseller"
        ],
        "Description"  => [
            "Type"  => "System",
            "Value" => "Zolui is a leading domain, hosting service provider. As our reseller program our reseller can sell domain beside with hosting plan or other service. Reseller will get domain at a discounted price. More details visit our official site.
...
WhatsApp: https://wa.me/+8801814892939"
        ...
        "ApiEndpoint"  => [
            ...
            "Default"      => "https://client.zolui.com/modules/addons/DomainsReseller/api/index.php"
        ],
    ];
 ...
 * @return array $return
 */
function ZoluiDomainReseller_RegisterDomain($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function ZoluiDomainReseller_TransferDomain($params)
{
    $postfields =
        [
            "domain"       => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_RenewDomain($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_GetNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function ZoluiDomainReseller_SaveNameservers($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_ReleaseDomain($params)
{
    $postfields =
        [
            "domain"      => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_GetEPPCode($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_GetContactDetails($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_SaveContactDetails($params)
{
    $postfields =
        [
            "domain"         => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_GetRegistrarLock($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_SaveRegistrarLock($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_GetDNS($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_SaveDNS($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_RegisterNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_ModifyNameserver($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_DeleteNameserver($params)
{
    $postfields =
        [
            "domain"     => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_RequestDelete($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function ZoluiDomainReseller_TransferSync($params)
{
    $postfields =
        [
 ...
 * @return array $return
 */
function ZoluiDomainReseller_Sync($params)
{
    $postfields =
        [
            "domain" => "{$params["sld"]}.{$params["tld"]}"
 ...
 * @return array $return
 */
function ZoluiDomainReseller_GetEmailForwarding($params)
{
    $postfields =
        [
            "domain" => $params["domainname"]
 ...
 * @return array $return
 */
function ZoluiDomainReseller_SaveEmailForwarding($params)
{
    $postfields =
        [
            "domain"    => $params["domainname"],
 ...
 * @return array $return
 */
function ZoluiDomainReseller_IDProtectionToggle($params)
{
    $postfields =
        [
            "domain" => $params["domainname"],
 ...
 * @return array
 */
function ZoluiDomainReseller_IDProtectToggle($params)
{
    return ZoluiDomainReseller_IDProtectionToggle($params);
}
 ...
 */
function ZoluiDomainReseller_CheckAvailability($params)
{
    $postfields =
        [
